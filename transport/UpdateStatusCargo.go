...
func (aphService) UddateStatusDeliveryService(_ context.Context, del dt.Delivery) []dt.Delivery {
	return call_ServiceUpdateStatusDeliveryService(del)
}

func call_ServiceUpdateStatusDeliveryService(del dt.Delivery) []dt.Delivery {
	retDel := svc.UpdateStatusDelivery(del)

	return retDel
}

func makeUpdateStatusDeliveryEndpoint(aph AphService) endpoint.Endpoint {
	log.Println("Process")
...
func decodeUpdateDeliveryStatusRequest(_ context.Context, r *http.Request) (interface{}, error) {
...
func RegisterHttpsServicesAndStartListener() {
	...
	http.Handle("/UpdateStatusDelivery", UpdateStatusDeliveryHandler)
